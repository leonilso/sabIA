...
O **sabIA** é uma solução desenvolvida durante a **Startup Weekend** com o objetivo de gerar provas personalizadas utilizando Inteligência artificiaisl. O nome une a sabedoria (saber) com a tecnologia (IA), simbolizado pela agilidade e canto do pássaro Sabiá.
...
* **Integração com IA:** Utilização de modelos de [SLM/Machine Learning] para processamento de dados.
